...
public final class Sentence implements Serializable, Iterable<Token>, Comparable<Sentence> {
	...
	private final int quotationOffset;
	 ...
	 */
	public Sentence(List<Token> tokens, String articleUid, int index, int quotationOffset, int leftOffset, int rightOffset, boolean skipChecks) {
		this.tokens = tokens;
	 ...
	 * @param index The index of this sentence within the article (starting from 0)
	 */
	public Sentence(List<Token> tokens, String articleUid, int index, int quotationOffset, int leftOffset, int rightOffset) {
		this(tokens, articleUid, index, quotationOffset, leftOffset, rightOffset, false);
	}
	...
	public Sentence(List<Token> tokens, boolean skipChecks) {
		this(tokens, "", -1, 0, 0, 0, skipChecks);
	}
	...
	public int getQuotationOffset() {
		return quotationOffset;
	}
	 ...
	 */
	public Tuple2<String, Integer> getKey() {
		return new Tuple2<>(articleUid, index);
	}
	
	/**
	 * Gets all the attributes of this Sentence.
	 * @return An (Article UID, index within article, left Offset, right Offset) pair
	 */
	public Tuple5<String, Integer, Integer, Integer, Integer> getInfo() {
		return new Tuple5<>(articleUid, index, quotationOffset, leftOffset, rightOffset);
	}
